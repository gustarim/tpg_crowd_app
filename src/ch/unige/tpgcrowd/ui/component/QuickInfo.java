 ...
 */
public class QuickInfo extends PopupWindows implements OnDismissListener {
	 ...
	 */
	public QuickInfo(Context context) {
		super(context);
	 ...
	 */
	public InfoItem getActionItem(int index) {
	...
	public void addInfoItem(InfoItem item) {
		...
		container = mInflater.inflate(R.layout.info_item_vertical, null);
	 ...
	 */
	public void setOnDismissListener(QuickInfo.OnDismissListener listener) {
